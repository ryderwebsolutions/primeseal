...
export default function CTAInlineStrip() {
  return (
    <div className="mt-10 rounded-2xl border border-navy/12 bg-white px-5 py-5 shadow-[0_16px_34px_-28px_rgba(11,31,58,0.52)] sm:px-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <p className="max-w-[65ch] text-sm leading-relaxed text-navy/78 sm:text-base">{ctaBlurb}</p>
